...
function Slide() {
    return (
        <>
            ...
            <Carousel fade >
                <Carousel.Item>
                    <img style={{height:'400px', width:'500px !improtant' }}
                ...
                <Carousel.Item>
                    <img
                        style={{height:'400px', width:'800px' }}
                        className="d-block w-100"
                        src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8cHJvZHVjdHxlbnwwfHwwfHw%3D&w=1000&q=80"
                        alt="Third slide"
                    />
